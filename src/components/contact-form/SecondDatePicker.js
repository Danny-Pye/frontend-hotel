...
let secondInputRef = React.createRef();
...
export default class DatePicker extends Component {
    ...
    updateDateFromInput =()=> {
        let dateValue = secondInputRef.current.value;
    ...
    setDateToInput =(timestamp)=> {
        ...
        secondInputRef.current.value = dateString;
    }
        ...
        return (
            <div className='MyDatePicker'>
                <div className='mdp-input'  onClick={()=> this.showDatePicker(true)}>
                    <input type='date' onChange={this.updateDateFromInput} ref={secondInputRef}/>
                </div>
